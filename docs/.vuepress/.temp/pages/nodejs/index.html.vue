<template><div><h2 id="什么是nodejs" tabindex="-1"><a class="header-anchor" href="#什么是nodejs" aria-hidden="true">#</a> 什么是NodeJs</h2>
...
<p>这允许 Node.js 使用单个服务器处理数千个并发连接，而​​不会引入管理线程并发（这可能是错误的重要来源）的负担。</p>
...
<p>大量的库
npm 以其简单的结构帮助 Node.js 生态系统蓬勃发展，现在 npm 仓库托管了超过 1,000,000 个开源包，你可以自由使用。</p>
<h2 id="node-js-应用程序的示例" tabindex="-1"><a class="header-anchor" href="#node-js-应用程序的示例" aria-hidden="true">#</a> Node.js 应用程序的示例</h2>
<p>Node.js 中最常见的 Hello World 示例是 Web 服务器：</p>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>要运行此代码片段，则将其另存为 server.js 文件并在终端中运行 node server.js。</p>
<p>此代码首先引入 Node.js http 模块。</p>
<p>Node.js 有一个很棒的标准库，包括一流的网络支持。</p>
<p>http 的 createServer() 方法创建新的 HTTP 服务器并返回。</p>
<p>服务器设置为监听指定的端口和主机名。 当服务器准备好时，则回调函数被调用，在此示例中会通知我们服务器正在运行。</p>
<p>每当接收到新请求时，都会调用 request 事件，其提供两个对象：请求（http.IncomingMessage 对象）和响应（http.ServerResponse 对象）。</p>
